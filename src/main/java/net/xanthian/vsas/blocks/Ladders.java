...
public class Ladders {
    ...
    public static final Block MANGROVE_LADDER = registerLadderBlock("ladders/oak_ladder", new VariantLadderBlock());
    public static final Block OAK_LADDER = registerLadderBlock("ladders/mangrove_ladder", new VariantLadderBlock());
