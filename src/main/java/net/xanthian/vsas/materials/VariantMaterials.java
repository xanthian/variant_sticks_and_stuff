...
public enum VariantMaterials implements ToolMaterial {
    ...
    BAMBOO_PLANK(0, 59, 2.0F, 0.0F, 15, () -> Ingredient.ofItems(Items.BAMBOO_PLANKS)),
    BIRCH_PLANK(0, 59, 2.0F, 0.0F, 15, () -> Ingredient.ofItems(Items.BIRCH_PLANKS)),
    CHERRY_PLANK(0, 59, 2.0F, 0.0F, 15, () -> Ingredient.ofItems(Items.CHERRY_PLANKS)),
    ...
    VariantMaterials(int miningLevel, int itemDurability,
